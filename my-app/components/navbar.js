        ...
        <nav className={`navbar navbar-expand-xl fixed-top ${scrolled ? "bg-dark" : "bg-transparent"} `} aria-label="Main Navigation">
          <div className="container py-2">
            <div className="text-center text-md-start py-2">
              <img src="../images/logo.svg" alt="cxontology logo" width={250} height={40} loading="lazy" />
            </div>
            ...
            <div className="offcanvas offcanvas-end" tabIndex="-1" id="navbarOffcanvasLg" aria-labelledby="navbarOffcanvasLgLabel">
              ...
              <div className="offcanvas-body">
                <ul className="navbar-nav link align-items-center ms-auto gap-3">
                  ...
                  <li className="nav-item"><a className="nav-link" href="#">Thought Leadership</a></li>
                  <div>
                    <button type='button' className='btn btn-primary d-flex align-items-center'>Contact CXO<span class="mdi mdi-chevron-right ps-1 fs-4 lh-sm"></span></button>
                  </div>
                </ul>
              </div>
            </div>
